...
def conversion ():
    #convert to vp8
    os.system("ffmpeg -i BBB_video_cut_120.mp4 -c:v libvpx -b:v 1M -c:a libvorbis BBB_video_120_vp8.webm")
    os.system("ffmpeg -i BBB_video_cut_240.mp4 -c:v libvpx -b:v 1M -c:a libvorbis BBB_video_240_vp8.webm")
    os.system("ffmpeg -i BBB_video_cut_480.mp4 -c:v libvpx -b:v 1M -c:a libvorbis BBB_video_480_vp8.webm")
    os.system("ffmpeg -i BBB_video_cut_720.mp4 -c:v libvpx -b:v 1M -c:a libvorbis BBB_video_720_vp8.webm")

    #convert to vp9
    os.system("ffmpeg -i BBB_video_cut_120.mp4 -c:v libvpx-vp9 -b:v 2M BBB_video_120_vp9.webm")
    os.system("ffmpeg -i BBB_video_cut_240.mp4 -c:v libvpx-vp9 -b:v 2M BBB_video_240_vp9.webm")
    os.system("ffmpeg -i BBB_video_cut_480.mp4 -c:v libvpx-vp9 -b:v 2M BBB_video_480_vp9.webm")
    os.system("ffmpeg -i BBB_video_cut_720.mp4 -c:v libvpx-vp9 -b:v 2M BBB_video_720_vp9.webm")

    #convert to h265
    os.system("ffmpeg -i BBB_video_cut_120.mp4 -c:v libx265 -c:a aac -b:a 128k BBB_video_120_h265.mp4")
    os.system("ffmpeg -i BBB_video_cut_240.mp4 -c:v libx265 -c:a aac -b:a 128k BBB_video_240_h265.mp4")
    os.system("ffmpeg -i BBB_video_cut_480.mp4 -c:v libx265 -c:a aac -b:a 128k BBB_video_480_h265.mp4")
    os.system("ffmpeg -i BBB_video_cut_720.mp4 -c:v libx265 -c:a aac -b:a 128k BBB_video_720_h265.mp4")

    #convert to av1
    os.system("ffmpeg -i BBB_video_cut_120.mp4 -c:v libaom-av1 -crf 30 -b:v 0 -strict experimental BBB_video_120_av1.mkv")
    os.system("ffmpeg -i BBB_video_cut_240.mp4 -c:v libaom-av1 -crf 30 -b:v 0 -strict experimental BBB_video_240_av1.mkv")
    os.system("ffmpeg -i BBB_video_cut_480.mp4 -c:v libaom-av1 -crf 30 -b:v 0 -strict experimental BBB_video_480_av1.mkv")
    os.system("ffmpeg -i BBB_video_cut_720.mp4 -c:v libaom-av1 -crf 30 -b:v 0 -strict experimental BBB_video_720_av1.mkv")
...
while ex != "0":
    ...
    if ex=="1":
        ...
        print("Playing the h265 mosaic (closa window to continue)")
        os.system("ffplay mosaic_h265.mp4")
        #vp8 mosaic
        ...
        print("Playing the vp8 mosaic (closa window to continue)")
        os.system("ffplay mosaic_vp8.webm")
        #vp9 mosaic
        ...
        print("Playing the vp9 mosaic (closa window to continue)")
        os.system("ffplay mosaic_vp9.webm")
        #av1 mosaic
